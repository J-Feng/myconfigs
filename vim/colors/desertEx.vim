...
hi VertSplit    guifg=#b9b9b9        guibg=#3e3e5e  gui=NONE
...
hi LineNr       guifg=#8b8bcd        guibg=#2e2e2e  gui=NONE
...
"hi StatusLine   guifg=gray80         guibg=#445599  gui=bold
hi StatusLine   guifg=#b9b9b9        guibg=#3e3e5e  gui=NONE
hi User1        guifg=#00ff8b        guibg=#3e3e5e  gui=BOLD
hi User2        guifg=#7070a0        guibg=#3e3e5e  gui=NONE
...
hi User1        cterm=BOLD,reverse
" ctermfg=#00ff8b        ctermbg=#2e3e5e  
hi User2        cterm=reverse
" ctermfg=#7070a0        ctermbg=#3e3e5e  
