...
if has("gui_running")
    ...
    hi Visual         gui=none   guifg=#2b2b2b    guibg=#ffa54f     

    hi Comment        gui=NONE   guifg=#cd8b00   guibg=NONE
    "hi Comment        gui=NONE   guifg=#7ccd7c   guibg=NONE
    "hi Constant       gui=NONE   guifg=#ffcd8b   guibg=NONE
    hi Constant       gui=none   guifg=#ff8371         
    "hi String         gui=NONE   guifg=#ffcd8b   guibg=#404040
    hi String         gui=none   guifg=#ff8371
